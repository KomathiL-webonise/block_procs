...
service_project = Service.new('Healthcare web', 'client 1', 20000)
product_project = Product.new('webonise portal', 'client 2', 900000)
company.add_project(service_project)
company.add_project(product_project)
hr = HR.new('HR Manager')
employee1 = Employee.new('Anu', 25, 'HR', 'Recruitment', 'Recruiter')
employee2 = Employee.new('komathi', 28, 'Engineering', 'Development', 'Software Engineer')
